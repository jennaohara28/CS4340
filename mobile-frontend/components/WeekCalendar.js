...
const styles = StyleSheet.create({
    ...
    calendar: { padding:10, backgroundColor:'#fff7e6', borderRadius:8, marginTop:10 },
    dayColumn: { width:80, padding:5, alignItems:'center', borderWidth:1, borderColor:'#ddd', marginRight:5, borderRadius:4, minHeight: 150 },
